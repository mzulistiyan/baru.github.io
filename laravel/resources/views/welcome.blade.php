    ...
    <body id="myPage">
        ...
        <div class="w3-container w3-padding-64 w3-center" id="team">
            ...
            <div class="w3-row"><br>
                ...
                <div class="w3-quarter">
                    <img
                        src="public/modal/mang_oleh.jpg"
                        alt="Boss"
                        style="width:50%"
        ...
        <div class="w3-row-padding w3-padding-64 w3-theme-l1" id="work">
            ...
            <div class="w3-quarter">
                <div class="w3-card w3-white">
                    <img src="public/modal/mang_oleh.jpg" alt="Snow" style="width:100%">
            ...
            <div class="w3-quarter">
                <div class="w3-card w3-white">
                    <img src="public/modal/mang_oleh.jpg" alt="Lights" style="width:100%">
                    <div class="w3-container">
                        <h3>mang oleh</h3>
                        <h4>Marketing Odading</h4>
                        <p>Lorem ipsum</p>
            ...
            <div class="w3-quarter">
                <div class="w3-card w3-white">
                    <img src="public/modal/mang_oleh.jpg" alt="Mountains" style="width:100%">
                    <div class="w3-container">
                        <h3>mang oleh</h3>
                        <h4>Marketing Odading</h4>
                        <p>Lorem ipsum</p>
        ...
        <footer class="w3-container w3-padding-32 w3-theme-d1 w3-center">
            ...
            <a
                ...
                href="https://www.instagram.com/telclab/"
                title="Instagram">
                <i class="fa fa-instagram"></i>
            </a>
            <a
                class="w3-button w3-large w3-teal w3-hide-small"
                href="https://timeline.line.me/user/_dTiNiqr5zS90zzPJOuG30LUon2l5lzU4BtaQxRk?utm_medium=osx&utm_source=desktop&utm_campaign=OA_Profile"
                title="Line">
